...
class LinkedinController(SeleniumHelper):
    ...
    SECTIONS['CONTENT']['INDUSTRY'] = {'selector': '#demographics dd.descriptor:nth-child(2)', 'type': 'text',
                                       'quantity': 'single'}
    SECTIONS['CONTENT']['RECOMMENDATIONS_NUMBER'] = {
        'selector': '.extra-info > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(2) > strong:nth-child(1)',
        'type': 'text',
        'quantity': 'single'
    }
    SECTIONS['CONTENT']['SUMMARY'] = {'selector': '#summary .description', 'type': 'text', 'quantity': 'single'}

    SECTIONS['CONTENT']['BRIEF_CURRENT'] = {'selector': '[data-section="currentPositionsDetails"] li',
                                            'quantity': 'multiple'}
    ...
    SECTIONS['CONTENT']['BRIEF_PREVIOUS'] = {'selector': '[data-section="pastPositionsDetails"] li',
                                             'quantity': 'multiple'}
    ...
    SECTIONS['CONTENT']['BRIEF_EDUCATION'] = {'selector': '[data-section="educationsDetails"] li',
                                              'quantity': 'multiple'}
    ...
    SECTIONS['CONTENT']['VOLUNTEER_OPPORTUNITIES'] = {'selector': '#volunteering div.opportunities.extra-section li',
                                                      'quantity': 'multiple'}
    ...
    SECTIONS['CONTENT']['VOLUNTEER_CAUSES'] = {
        'selector': '#volunteering div.extra-section:nth-child(2) > ul:nth-child(2) > li', 'quantity': 'multiple'}
    FIELDS['CONTENT']['VOLUNTEER_CAUSES'] = {}
    FIELDS['CONTENT']['VOLUNTEER_CAUSES']['NAME'] = {'selector': '', 'type': 'text'}

    SECTIONS['CONTENT']['VOLUNTEER_SUPPORT'] = {
        'selector': '#volunteering div.extra-section:nth-child(3) > ul:nth-child(2) > li', 'quantity': 'multiple'}
